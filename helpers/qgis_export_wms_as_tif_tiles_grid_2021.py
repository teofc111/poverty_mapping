...
## INPUT
output_folder = "data/daysat/2021_grid/"          # Define output folder
shape_name = "grid_phil_2021_extents_epsg4326"    # Define shape name for clipping image tiles from map
map_name = "Sentinel-2 cloudless layer for 2021 by EOX - 4326"      # Define name of Sentinel-2 map layer loaded in QGIS
